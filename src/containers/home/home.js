          ...
          <div className="row section1-main" id="contact-section">
            ...
            <div className="col-sm-4 col-4 call_us">
              <a href="tel:+91-9985556775">
                ...
                <div className="contact">+91-9985556775</div>
                <div className="contact">+91-9985556776</div>
              </a>
            </div>
            <div className="col-sm-4 col-4 support">
              <div className="icon">
                <div className='support_icon'/>
              </div>
              <div className="heading">SUPPORT</div>
              <div className="contact">Chat with us</div>
            </div>
          </div>
        </div>
      </div>
